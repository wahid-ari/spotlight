  ...
  return (
    <>
      ...
      <div className='bg-neutral-50 dark:bg-black relative'>
        ...
        <div className='flex justify-center overflow-hidden sm:px-8 md:px-12 lg:px-16'>
          <div className='w-full min-h-screen mx-1.5 max-w-7xl bg-white ring-1 ring-neutral-100 dark:bg-neutral-900 dark:ring-neutral-300/20'>
            ...
            <section className='scroll-mt-24 mt-16 sm:mt-20 mx-0 sm:-mx-8 md:-mx-12 lg:-mx-16 xl:-mx-28 2xl:-mx-40'>
                  ...
                  {filteredPortfolios.map((item, index) => (
                    ...
                    >
                      <PortfolioCard
                        ...
                        image={item.images[0]}
                        url={item.url}
                        onClick={() => handleOpenPortfolio(item.name, index)}
                      />
                    </motion.div>
                  ))}
                </AnimatePresence>
